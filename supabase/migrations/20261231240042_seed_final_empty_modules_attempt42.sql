...
-- ==========================================
-- ROLE SIMULATOR & USER PROFILES
-- ==========================================
INSERT INTO user_profiles (id, tenant_id, email, full_name, role, title) VALUES
  ('b1000000-0000-0000-0000-000000000001', '11111111-1111-1111-1111-111111111111', 'hasan.aksoy@sentinel.com', 'Dr. Hasan Aksoy', 'admin', 'Chief Audit Executive (CAE)'),
  ('b1000000-0000-0000-0000-000000000002', '11111111-1111-1111-1111-111111111111', 'elif.demir@sentinel.com', 'Elif Demir', 'auditor', 'Kıdemli IT Denetçisi'),
  ('b1000000-0000-0000-0000-000000000003', '11111111-1111-1111-1111-111111111111', 'ahmet.yilmaz@sentinel.com', 'Ahmet Yılmaz', 'executive', 'Genel Müdür Yardımcısı (GMY)'),
  ('b1000000-0000-0000-0000-000000000004', '11111111-1111-1111-1111-111111111111', 'ayse.kaya@sentinel.com', 'Ayşe Kaya', 'auditee', 'Kredi Yetkilisi / Denetlenen'),
  ('b1000000-0000-0000-0000-000000000005', '11111111-1111-1111-1111-111111111111', 'mehmet.celik@sentinel.com', 'Mehmet Çelik', 'guest', 'Dış Denetim / Bayi (Supplier)')
ON CONFLICT (email) DO NOTHING;

-- Tablo okuma izinleri garantiye alınır:
