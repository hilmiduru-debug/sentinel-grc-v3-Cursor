...
import {
  ShieldHumbug, Key, LockKeyhole, EyeOff, Search,
  Unlock, CheckCircle2, AlertTriangle, Fingerprint, FileText, Activity
} from 'lucide-react';
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
        <StatCard icon={ShieldHumbug} label="Şifreli İhbar" value={String(total)} sub="Kasadaki toplam rapor" color="slate" />
