...
import {
  Activity, AlertOctagon, TrendingDown,
  Clock, ShieldAlert, Cpu, Zap, ChevronRight, CheckCircle2,
  BarChart4
} from 'lucide-react';
import {
  useMarketAlerts, useUpdateAlertStatus, formatUSD,
  type MarketRiskAlert, type AlertStatus
