import { ArrowRight, Brain, CheckCircle, Lock, Mail, Shield, XCircle } from 'lucide-react';
...
export default function LoginPage() {
 ...
 return (
 <div className="min-h-screen relative overflow-hidden bg-slate-950 text-slate-200 flex items-center justify-center">
 <div className="absolute inset-0 bg-[url('data:image/svg+xml;base64,)” stroke-width=”1″/></pattern></defs><rect width=”100%” height=”100%” fill=”url(#grid)”/></svg>')] opacity-30" />
 ...
 <div className="relative z-10 flex items-center justify-center min-h-screen p-6 w-full">
 ...
 <div className="bg-slate-900/80 backdrop-blur-xl border border-slate-700/50 rounded-2xl p-8 shadow-[0_0_40px_rgba(59,130,246,0.1)]">
 <div className="mb-6">
 ...
 className="w-full pl-11 pr-4 py-3 bg-slate-950/50 border border-slate-700 rounded-xl text-white placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500 shadow-inner transition-all"
 required
 ...
 type="submit"
 disabled={loading || success}
 className="w-full relative overflow-hidden bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 text-white font-bold py-3.5 rounded-xl shadow-[0_0_15px_rgba(147,51,234,0.4)] hover:shadow-[0_0_25px_rgba(147,51,234,0.6)] transition-all hover:scale-[1.02] disabled:opacity-50 disabled:cursor-not-allowed group"
 >
