...
import {
  FileText, Plus, Search, Loader2, Sparkles, AlertCircle,
  LayoutGrid, FileEdit, Eye, CheckCircle, List, ChevronLeft,
  ChevronRight, Award, Gauge, AlertTriangle, Ban, Clock, Tag,
  History,
} from 'lucide-react';
